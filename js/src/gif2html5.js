...
(function() {
	if (window.Modernizr && Modernizr.addTest) {

		var timeout;
		var waitTime = 300;
		var elem = document.createElement('video');
		var elemStyle = elem.style;
		var testName = 'gif2html5-videoautoplay';
		var addTest = function(result) {
		...
		document.documentElement.className += ' gif2html5-no-modernizr';
	}
})();
